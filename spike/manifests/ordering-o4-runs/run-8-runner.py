...
for line in git('ls-tree', '-r', 'HEAD', '--', 'spike/src', 'spike/fixtures', 'spike/test', 'spike/manifests/ordering-lifecycle.ts', 'spike/manifests/ordering-lifecycle.md', 'spike/ordering-profile.md').splitlines():
