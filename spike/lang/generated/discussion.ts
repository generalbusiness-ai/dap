// Generated by t1-draft-1. Source sha256:2127f991e4721f18a63458c617e7dfd730b0d150d71af8370d037c1063137a5a. Do not edit.
...
const declaration: Declaration = {
  ...
  "acts": [
    {
      "kind": "example.discussion.post",
      "readers": "members",
      "max": "members",
      "capability": "example.discussion.post",
      "schema": {
        "id": "string",
        "title": "string"
      },
    ...
    {
      "kind": "example.discussion.post_text",
      "readers": "author",
      "max": "author",
      "capability": "example.discussion.post",
      "schema": {
...
export const discussionPackage = makePackage(declaration, "sha256:2127f991e4721f18a63458c617e7dfd730b0d150d71af8370d037c1063137a5a", "t1-draft-1", import.meta.url, ["example.discussion.post"], ["example.discussion.post","ai.generalbusiness.dap.attach"]);
export const discussionModel = discussionPackage.models["discussion"]!;
export const DISCUSSION = "example.discussion.";
