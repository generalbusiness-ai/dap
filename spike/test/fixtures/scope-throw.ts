...
export const scopeThrowKind = 'com.example.qa-fault.event';
const base: Omit<PackageDescriptor,'id'> = {
  ...
  kinds:{ [SCOPE_KINDS.exercise]:{
    ...
    kind:scopeThrowKind,schema:{},handlers:['qaFault'],audienceId:'qa-fault',
    audience:()=>{ throw new Error('qa_audience_exception'); },capability:SCOPE_KINDS.exercise,
  } },
};
