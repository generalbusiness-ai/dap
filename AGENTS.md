...
Simplicity is more valuable than features.  Clear and simple communication is a part of the work; a stable projection of the events that produced the current state.
...
Dispatch appropriately-skilled subagents for parallel work.
